...
export class TheBigFanStack extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    sqsCreatedStatusSubscribeLambda.addEventSource(new SqsEvent.SqsEventSource(createdStatusQueue, {}));
    ...
    sqsAnyOtherStatusSubscribeLambda.addEventSource(new SqsEvent.SqsEventSource(anyOtherStatusQueue, {}));
